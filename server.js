...
// Database connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/aquarian-pool-spa')
...
app.use(session({
  ...
  store: MongoStore.create({
    mongoUrl: process.env.MONGODB_URI || 'mongodb://localhost:27017/aquarian-pool-spa',
  }),
  cookie: {
